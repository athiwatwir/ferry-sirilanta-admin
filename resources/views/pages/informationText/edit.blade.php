...
<x-card>
    <x-form :action="route('informationText.update', $information->id)">
        @method('put')
        <div class="row">
            <div class="col-12 col-lg-6">
                <x-form.float.input name="title" label="Title" :value="$information->title" />
            </div>
            <div class="col-12 col-lg-6">
                <x-form.float.selection name="position" label="Position" :options="$positions" :default="$information->position" />
            </div>
