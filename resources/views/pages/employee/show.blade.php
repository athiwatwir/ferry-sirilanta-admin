                ...
                <div class="col-12 col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-2 text-end">
                            <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modal-edit-employee">Edit</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<x-modal id="modal-edit-employee" title="แก้ไขข้อมูล Employee">
    <x-form type="modal" :action="route('employee.update', $employee)" method="POST">
        @method('PUT')
        <div class="row">
            <div class="col-12 col-lg-6">
                <x-form.float.input name="name" label="Name" :value="old('name', $employee->name)" :isrequire="true" />
            </div>
            <div class="col-12 col-lg-6">
                <x-form.float.input name="code" label="Code" :value="old('code', $employee->code ?? $employee->user?->code)" :isrequire="false" />
            </div>
            <div class="col-12">
                <x-form.float.input name="email" label="Email" type="email" :value="old('email', $employee->user?->email)" :isrequire="true" />
            </div>
            <div class="col-12">
