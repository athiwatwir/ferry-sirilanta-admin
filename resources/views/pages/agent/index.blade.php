                    ...
                    <tbody>
                        @foreach ($agents as $item)
                            <tr>
                                ...
                                <td class="text-center clickable-row pointer"
                                    data-href="{{ route('agent.route', ['agent' => $item]) }}">
                                ...
                                <td class="text-end">
                                    <x-button.dropdown editUrl="" :deleteUrl="route('agent.destroy', ['agent' => $item->id])">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('agent.route', ['agent' => $item]) }}"><i
                                                    class="icon-base ti tabler-device-projector icon-22px"></i> View</a>
                                        </li>
                                    </x-button.dropdown>
                                </td>
                            </tr>
