...
<x-card>
    <x-form>
        <div class="row">
            <div class="col-12">
                <x-form.float.input label="Title" name="title" :value="$promotion['title']" />
            </div>
            <div class="col-12 col-lg-3">
                <x-form.float.input name="code" label="Code" :value="$promotion['code']" />
            </div>
            <div class="col-8 col-lg-2">
                <x-form.float.input name="discount" label="Discount" :value="$promotion['discount']" />
            </div>
