            ...
            <form novalidate="" class="bs-validate" id="fee-update-form" method="POST" action="https://app.tigerlineferry.com/fee-manage/update">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="child-pf-2C2P" name="child_pf_2C2P" step="any">
                                                                        <label for="child-pf-2C2P" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="infant-pf-2C2P" name="infant_pf_2C2P" step="any">
                                                                        <label for="infant-pf-2C2P" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="child-sc-2C2P" name="child_sc_2C2P" step="any">
                                                                        <label for="child-sc-2C2P" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="infant-sc-2C2P" name="infant_sc_2C2P" step="any">
                                                                        <label for="infant-sc-2C2P" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 d-block d-lg-none">
                                <h2 class="text-main-color-2 text-center">PAY@ALL</h2>
                            </div>
                            <div class="col-12 col-md-10 order-2 order-lg-1">
                                <div class="row">
                                    <div class="col-12 d-none d-lg-block">
                                        <h2 class="text-main-color-2">PAY@ALL</h2>
                                    </div>
                                    <div class="col-12 col-lg-6 border-lg-end border-2 border-bottom border-lg-bottom-0 border-color-main mb-3 mb-lg-0 pb-3 pb-lg-0">
                                        <h6 class="text-center mb-3 fw-bold">Processing fee (เลือกได้เพียงอย่างเดียว)</h6>
                                        <div class="checkgroup js-checkgroup" data-checkgroup-checkbox-single="true">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-check mb-2 float-end">
                                                                <input class="form-check-input form-check-input-primary is-pf-perperson-PATALL" type="checkbox" name="is_pf_perperson_PATALL" value="Y" id="perperson-pf-check-PATALL">
                                                                <label class="form-check-label" for="perperson-pf-check-PATALL">
                                                                    Per/person
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="regular-pf-PATALL" name="regular_pf_PATALL" step="any">
                                                                        <label for="regular-pf-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="child-pf-PATALL" name="child_pf_PATALL" step="any">
                                                                        <label for="child-pf-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="infant-pf-PATALL" name="infant_pf_PATALL" step="any">
                                                                        <label for="infant-pf-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-6 border-start border-2">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input form-check-input-primary is-pf-perperson-PATALL" type="checkbox" name="is_pf_perperson_PATALL" value="N" id="allperson-pf-check-PATALL" checked="">
                                                        <label class="form-check-label" for="allperson-pf-check-PATALL">
                                                            % All person/ ticket
                                                        </label>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <input type="number" class="form-control form-control-sm text-center w-50" name="percent_pf_PATALL" value="5.57" step="any">
                                                        <label class="mb-0 ms-1 form-label smaller">%</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-check mb-2 float-end">
                                                                <input class="form-check-input form-check-input-primary is-sc-perperson-PATALL" type="checkbox" name="is_sc_perperson_PATALL" value="Y" id="perperson-sc-check-PATALL" checked="">
                                                                <label class="form-check-label" for="perperson-sc-check-PATALL">
                                                                    Per/person
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="regular-sc-PATALL" name="regular_sc_PATALL" step="any">
                                                                        <label for="regular-sc-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="child-sc-PATALL" name="child_sc_PATALL" step="any">
                                                                        <label for="child-sc-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-7 ps-0 text-end">
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <input type="number" class="form-control form-control-sm px-2 w--60 text-center" value="0.00" id="infant-sc-PATALL" name="infant_sc_PATALL" step="any">
                                                                        <label for="infant-sc-PATALL" class="mb-0 ms-1 form-label smaller">Bath</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-6 border-start border-2">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input form-check-input-primary is-sc-perperson-PATALL" type="checkbox" value="N" name="is_sc_perperson_PATALL" id="allperson-sc-check-PATALL">
                                                        <label class="form-check-label" for="allperson-sc-check-PATALL">
                                                            % All person/ ticket
                                                        </label>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <input type="number" class="form-control form-control-sm text-center w-50" name="percent_sc_PATALL" value="0.00" step="any">
                                                        <label class="mb-0 ms-1 form-label smaller">%</label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12 col-md-2 border-lg-start border-2 border-color-main order-1 order-lg-2 border-bottom border-lg-bottom-0 mb-3 mb-lg-0">
                                ...
                                <div class="checkgroup js-checkgroup" data-checkgroup-checkbox-single="false">
                                    <div class="row">
                                        <div class="col-6 col-lg-12 border-sm-end border-2">
                                            <div class="form-check mb-3 text-center text-lg-start">
                                                <input class="form-check-input form-check-input-primary" type="checkbox" value="Y" id="isuse-pf-PATALL" name="isuse_pf_PATALL" checked="">
                                                <label class="form-check-label" for="isuse-pf-PATALL">
                                                    Processing fee
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-lg-12 text-center text-lg-start">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input form-check-input-primary" type="checkbox" value="Y" id="isuse-sc-PATALL" name="isuse_sc_PATALL">
                                                <label class="form-check-label" for="isuse-sc-PATALL">
                                                    Service chage
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <input type="hidden" name="is_fee[]" value="9c9d2cf2-0c5b-4c3e-b7ea-5d612489c97a">
                    </div>
                </div>
