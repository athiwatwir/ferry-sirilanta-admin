...
<x-card>
    <div class="row">
        <div class="col-12">
            <x-form :action="route('report.booking')" method="GET" :isshow_button="false">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5">
                        <x-form.float.date-rang-picker label="Travel Date" />
                    </div>
                    <div class="col-12 col-lg-5">
            ...
            <form action="{{ route('print.reportBooking') }}" id="search_form" method="POST" target="_blank">
                @csrf
                <div class="row">
